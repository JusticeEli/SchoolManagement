            ...
            case R.id.logoutMenu:
                Backendless.UserService.logout(new AsyncCallback<Void>() {
                    ...
                    public void handleResponse(Void response) {
                        Toast.makeText(ChoosenClassActivity.this, "Logout Success", Toast.LENGTH_SHORT).show();
                    }

                    @Override
                    public void handleFault(BackendlessFault fault) {
                        Toast.makeText(ChoosenClassActivity.this, "Error: " + fault.getMessage(), Toast.LENGTH_SHORT).show();
