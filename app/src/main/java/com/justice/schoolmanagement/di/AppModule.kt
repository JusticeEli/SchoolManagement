...
import com.justice.schoolmanagement.presentation.ui.chat.ChatRepository
...
import com.justice.schoolmanagement.presentation.ui.splash.SplashScreenRepository
...
object AppModule {
    ...
    @Provides
    @Singleton
    fun provideChatRepo(@ApplicationContext context: Context): ChatRepository {
