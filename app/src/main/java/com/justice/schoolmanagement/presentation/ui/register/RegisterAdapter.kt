...
class RegisterAdapter(private val studentsFragment: Fragment, options: FirestoreRecyclerOptions<StudentRegistrationData>) : FirestoreRecyclerAdapter<StudentRegistrationData, RegisterAdapter.ViewHolder>(options) {
    companion object {
